...
- (void) resizeImageWidth:(double)width height:(double)height resolution:(double)resolution resampleMethod:(PhotoshopE175)resampleMethod;  // change the size of the image
